            ...
            <div className='max-w-6xl mx-auto py-20'>
                <div className="flex sm:flex-row flex-col">
                    <div className="flex-1 flex justify-center items-center">
                        <img className='lg:w-[350px] lg:h-[350px] w-[200px] h-[200px]' src={image} alt="" />
                    </div>
                    <div className='flex-3 sm:ml-10 sm:mt-0 mt-10'>
                        <div className='mb-[29.5px] sm:text-left text-center'>
                            <h3 className='text-3xl font-bold mb-2'>{title}</h3>
                            <p className='text-xl text-[#627382]'>Developed by <span className='text-[#986eec]'>{companyName}</span></p>
                        </div>
                        ...
                        <div className='mt-8.5 sm:p-0 p-4 text-center sm:text-left'>
                            <button className='btn bg-[#00d390] text-white rounded'>Install Now ({size} MB)</button>
                        </div>
                    </div>
                </div>
